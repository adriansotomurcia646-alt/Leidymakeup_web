...
def agenda_index(request):
    ...
    <head>
        <meta charset="UTF-8">
        <title>Agenda - Leidy Make Up</title>
        <style>
    ...
    <body>
        <div class="card">
            ...
            <p>Aquí se gestionan los horarios y las citas.</p>
            <p><strong>Modelos:</strong> Horario, Citas</p>
...
urlpatterns = [
    path('', agenda_index, name='agenda_index'),
]