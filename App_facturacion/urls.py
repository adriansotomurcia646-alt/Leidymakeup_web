...
def facturacion_index(request):
    ...
    <head>
        <meta charset="UTF-8">
        <title>Facturación - Leidy Make Up</title>
        <style>
    ...
    <body>
        <div class="card">
            ...
            <p>Aquí se gestionan los pagos y las facturas.</p>
            <p><strong>Modelos:</strong> Pago, Factura</p>
...
urlpatterns = [
    path('', facturacion_index, name='facturacion_index'),
]